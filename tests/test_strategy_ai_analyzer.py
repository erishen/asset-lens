...
class TestAIAnalyzer:
    ...
    def test_parse_response_valid_json(self):
        ...
        content = '{"d": "buy", "c": 80, "r": "技术面好", "rl": "low", "kf": ["因素1"], "ms": "乐观", "sl": 90, "tp": 110}'
...
class TestAITradingAdvisor:
    ...
    def test_evaluate_buy_signal_disabled(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            ...
            result = advisor.evaluate_buy_signal(
                stock_data={'code': 'sh600519'},
                strategy_score=80
            )
    ...
    def test_combine_decisions_buy_high_score(self):
        """测试组合决策（高分买入）"""
        from asset_lens.strategy.ai_analyzer import AITradingAdvisor, AIAnalysisResult, AIDecision
        advisor = AITradingAdvisor()
    ...
    def test_evaluate_sell_signal_disabled(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            ...
            result = advisor.evaluate_sell_signal(
                stock_data={'code': 'sh600519'},
                holding_data={'profit_rate': 5, 'holding_days': 10}
            )
            assert result['action'] == 'skip'
            assert result['strategy_only'] is True
