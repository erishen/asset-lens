...
from asset_lens.monitoring.risk_analyzer import RiskAlert, RiskAnalyzer, RiskMetrics
...
class TestRiskAnalyzer:
    ...
    def test_calculate_concentration_risk(self):
        holdings = {"stock1": 10000, "stock2": 20000, "stock3": 30000, "stock4": 40000}
    ...
    def test_check_risk_thresholds(self):
        metrics = RiskMetrics(
            volatility=30.0, max_drawdown=20.0, sharpe_ratio=0.3, beta=1.0, var_95=5.0, concentration_risk=40.0
        )
    ...
    def test_check_risk_thresholds_no_alerts(self):
        metrics = RiskMetrics(
            volatility=15.0, max_drawdown=8.0, sharpe_ratio=1.5, beta=1.0, var_95=3.0, concentration_risk=20.0
        )
    ...
    def test_generate_risk_report(self):
        metrics = RiskMetrics(
            volatility=20.0, max_drawdown=10.0, sharpe_ratio=1.2, beta=0.8, var_95=4.0, concentration_risk=25.0
        )
...
class TestRiskMetrics:
    ...
    def test_custom_metrics(self):
        metrics = RiskMetrics(
            volatility=25.0, max_drawdown=15.0, sharpe_ratio=1.5, beta=1.2, var_95=5.0, concentration_risk=30.0
        )
