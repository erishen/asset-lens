...
class ChartGenerator:
    ...
    def generate_all_charts(
        ...
        if "return_distribution" in portfolio_data:
            charts["return_distribution"] = self.generate_return_distribution_chart(
                ...
                filename=f"{prefix}return_distribution.png" if prefix else "return_distribution.png",
            )
    ...
    def generate_asset_allocation_chart(
        ...
        legend_labels = [f'{label}: ¥{value/10000:.1f}万 ({pct:.1f}%)' 
    ...
    def generate_cumulative_returns_chart(
        ...
        if benchmark_returns:
            ...
            ax.plot(bench_dates, bench_values, label='基准指数', linewidth=2, color='#95a5a6', linestyle='--')
