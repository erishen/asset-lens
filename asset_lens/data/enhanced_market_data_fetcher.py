...
from ..utils.http_client import HTTPClient, ErrorType
...
class EnhancedMarketDataFetcher:
    ...
    def _fetch_from_akshare_spot(self, index_code: str) -> Optional[Dict[str, Any]]:
        """从 AkShare 实时行情获取"""
        try:
    ...
    def fetch_foreign_index(self, symbol: str) -> Optional[Dict[str, Any]]:
        """获取国外指数（多数据源故障转移）
