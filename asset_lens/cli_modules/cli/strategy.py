...
def register_strategy_commands(cli: click.Group) -> None:
    ...
    from asset_lens.cli_modules.cli.strategy_auto_trade import register_auto_trade_command
    from asset_lens.cli_modules.cli.strategy_enhanced import register_enhanced_commands

    register_auto_trade_command(cli)
