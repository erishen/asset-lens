...
DEMO_PRODUCTS = [
    # A股
    {"类型": "A股", "名称": "华夏成长混合", "风险": "高", "初始金额": 50000, "收益率": 12.5, "年化收益": 12.5},
    {"类型": "A股", "名称": "招商科技先锋", "风险": "高", "初始金额": 30000, "收益率": -5.2, "年化收益": -5.2},
    {"类型": "A股", "名称": "中银价值精选", "风险": "中高", "初始金额": 25000, "收益率": 8.3, "年化收益": 8.3},
    # 美股
    {"类型": "美股", "名称": "环球科技指数基金", "风险": "高", "初始金额": 20000, "收益率": 18.7, "年化收益": 18.7},
    {"类型": "美股", "名称": "海外消费ETF", "风险": "中高", "初始金额": 15000, "收益率": 6.4, "年化收益": 6.4},
    # 基金
    {"类型": "基金", "名称": "南方稳健成长混合A", "风险": "中", "初始金额": 40000, "收益率": 9.1, "年化收益": 9.1},
    {"类型": "基金", "名称": "易方达蓝筹精选混合", "风险": "中高", "初始金额": 35000, "收益率": -2.8, "年化收益": -2.8},
    {"类型": "定投基金", "名称": "华夏沪深300指数增强A", "风险": "中高", "初始金额": 20000, "收益率": 7.6, "年化收益": 7.6},
    {"类型": "基金", "名称": "广发高端制造股票A", "风险": "高", "初始金额": 18000, "收益率": 15.3, "年化收益": 15.3},
    # 债券
    {"类型": "债券", "名称": "招商国债A", "风险": "低", "初始金额": 60000, "收益率": 3.8, "年化收益": 3.8},
    {"类型": "债券", "名称": "富国信用债A", "风险": "中低", "初始金额": 45000, "收益率": 4.2, "年化收益": 4.2},
    {"类型": "债券", "名称": "工银纯债债券A", "风险": "低", "初始金额": 30000, "收益率": 3.5, "年化收益": 3.5},
    # 现金
    {"类型": "现金", "名称": "天弘余额宝货币基金", "风险": "低", "初始金额": 80000, "收益率": 1.8, "年化收益": 1.8},
    {"类型": "美元基金", "名称": "华夏美元货币基金", "风险": "低", "初始金额": 25000, "收益率": 4.5, "年化收益": 4.5},
    # 黄金
    {"类型": "黄金", "名称": "华安黄金ETF联接A", "风险": "中", "初始金额": 20000, "收益率": 22.1, "年化收益": 22.1},
    # 个人养老金
    {"类型": "个人养老金", "名称": "兴全安泰积极养老Y", "风险": "中高", "初始金额": 12000, "收益率": 5.6, "年化收益": 5.6},
    # ETF
    {"类型": "ETF", "名称": "中证500ETF先锋", "风险": "高", "初始金额": 15000, "收益率": 10.2, "年化收益": 10.2},
    # 股息基金
    {"类型": "股息基金", "名称": "环球股息优势基金A", "风险": "中", "初始金额": 10000, "收益率": 7.8, "年化收益": 7.8},
]
